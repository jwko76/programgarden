"""Pydantic models for LS Securities OpenAPI t8412 (주식챠트(N분)(t8412)).
...
class T8412RequestHeader(BlockRequestHeader):
    pass


class T8412ResponseHeader(BlockResponseHeader):
    pass

class T8412InBlock(BaseModel):
    """t8412InBlock — input block. 기본입력"""
...
class T8412OutBlock1(BaseModel):
    """t8412OutBlock1 — output block (occurs — list of rows). 출력1"""
    ...
    sign: str = Field(
        default="",
        title="종가등락구분(1:상한2:상승3:보합4:하한5:하락)",
        description="sign — char(1). Consume as returned by LS.",
    )

class T8412Request(BaseModel):
    """Request envelope for t8412."""

    header: T8412RequestHeader = T8412RequestHeader(
    ...
    options: SetupOptions = SetupOptions(
        ...
        on_rate_limit="wait",
        rate_limit_key="t8412",
    )
    _raw_data: Optional[Response] = PrivateAttr(default=None)

class T8412Response(BaseModel):
    """Response envelope for t8412."""

    header: Optional[T8412ResponseHeader] = None
    block: Optional[T8412OutBlock] = None
    block1: List[T8412OutBlock1] = []
    rsp_cd: str = ""
    rsp_msg: str = ""
